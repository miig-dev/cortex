  ...
  persist(
    (set, get) => ({
      ...
      areas: [
        ...
        { id: 3, name: 'Web site', color: '#FF7733', createdAt: new Date(), updatedAt: new Date() },
        { id: 4, name: 'Health & Wellness', color: '#EF476F', createdAt: new Date(), updatedAt: new Date() },
        { id: 5, name: 'Admin', color: '#6B7280', createdAt: new Date(), updatedAt: new Date() },
        { id: 6, name: 'Personal Development', color: '#4CC9F0', createdAt: new Date(), updatedAt: new Date() },
      ],
      searchQuery: '',
      selectedArea: null,
