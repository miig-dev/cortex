    ...
    <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="text-center">
          ...
          <div className="text-xs" style={{ color: '#9CA3AF' }}>Tâches</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-green-400">{completionRate}%</div>
          <div className="text-xs" style={{ color: '#9CA3AF' }}>Complétion</div>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="flex items-center justify-between p-2 rounded text-xs" style={{ backgroundColor: '#2A0A0A' }}>
            <span style={{ color: '#EF476F' }}>🔥 Urgent</span>
            <span className="font-bold" style={{ color: '#EF476F' }}>
              {stats.tasksByQuadrant.urgent_important || 0}
            </span>
          </div>
          <div className="flex items-center justify-between p-2 rounded text-xs" style={{ backgroundColor: '#0A1A2A' }}>
          ...
          <div className="flex items-center justify-between p-2 rounded text-xs" style={{ backgroundColor: '#2A2A0A' }}>
          ...
          <div className="flex items-center justify-between p-2 rounded text-xs" style={{ backgroundColor: '#1A1A1A' }}>
